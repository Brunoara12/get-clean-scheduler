                ...
                <Sidebar className="!border-greenAccent-500" collapsed={isCollapsed}>
                    <Menu >
                        ...
                        <MenuItem
                            ...
                            className="mt-3 mb-5 text-grey-100">

                            {!isCollapsed && (
                                <div className="flex justify-between items-center ml-4">
                                    <h3 className="text-grey-100">ADMINS</h3>
                        ...
                        {!isCollapsed && (
                            <div className="mb-6 test">
                                ...
                                <div className="text-center">
                                    <h2 className="text-grey-100 font-bold mt-3">Bruno</h2>
                                    <h5 className="text-greenAccent-500">VP Admin</h5>
                                </div>
                            </div>)}
